...
return [
    'hero' => [
        'title' => 'Who are we?',
        'subtitle' => 'We are Happy Paws. A responsible animal shelter.',
        'description1' => 'We provide a safe and caring environment for abandoned animals at our shelter in Passendale.',
        'description2' => 'Every day, our team works to ensure their health, well-being, and to give them a second chance.',
    ],
    ...
    'values' => [
        ...
        'kindness' => [
            'title' => 'Kindness',
            'text' => 'Every animal is welcomed with gentleness and respect. We believe love and patience are the keys to their rehabilitation.'
        ],
        'transparency' => [
            'title' => 'Transparency',
            'text' => 'Our doors are open. Discover how we care for our animals and where every donation goes.'
        ],
        'commitment' => [
            'title' => 'Commitment',
            'text' => '24/7, our team monitors the well-being of every resident. Their happiness is our daily mission.'
        ],
        'community' => [
            'title' => 'Community',
            'text' => 'Together, we create a strong support network. Volunteers, adopters, and donors: you are the beating heart of our shelter.'
        ],
    ],
