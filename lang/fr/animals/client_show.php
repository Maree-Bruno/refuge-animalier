...
return [
    ...
    'adoption_text' => "Adopter Billy, c’est offrir une nouvelle chance à un chien qui ne demande qu’à aimer et être aimé.
        Notre équipe est disponible pour répondre à toutes vos questions et vous guider dans les démarches d’adoption.

        Avant de nous envoyer votre demande, assurez-vous de pouvoir lui offrir :
        ...
        Si vous pensez être la bonne famille pour lui, remplissez le formulaire ci-contre : nous vous recontacterons rapidement
        pour discuter de votre projet d’adoption et organiser une rencontre.",
